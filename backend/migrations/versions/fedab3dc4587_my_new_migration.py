...
Revision ID: fedab3dc4587
Revises: f7159ac9ff98
Create Date: 2025-09-12 17:02:11.058385
...
def upgrade() -> None:
    ...
    op.add_column('scenario_steps', sa.Column('batch_settings', sa.JSON(), nullable=True))
